...
public class DessertsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ListView dessert= findViewById(R.id.list_view_desserts);

        Dish[] desserts = {
                new Dish("Chocolate Muse", "Chocoloated stirred mouse", 1299),
        ...
        ArrayAdapter<Dish> mainDesserts =  new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, desserts);
        dessert.setAdapter(mainDesserts);
    }
}
