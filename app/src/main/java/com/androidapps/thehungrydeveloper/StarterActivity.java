...
public class StarterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] dishes = {
                ...
                new Dish("Melon and Lemon Soup", "Melon in a lemon soup base", 599),
                new Dish("Coconut and chocolate mousse", "Coconut shavings and chocolate mousse", 899),
                new Dish("Spinach and cabbage wontons", "Spinach and cabbage stuffed wontons", 1100),
