...
public class MainCoursesActivity extends  AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Dish[] courses = {
                new Dish("Avocado Thai Ginger Ceviche", "Fresh shrimp with lemon and thai ginger flavor", 1599),
                new Dish("Ginger Sweet Chile Tuna Tatare with Wasabi Sauce", "A tuna tatare marinated in sweet chile glaze and drizzled with wasabi sauce", 1799),
        ...
        ArrayAdapter<Dish> mainAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, courses);
